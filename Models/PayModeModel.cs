...
namespace Supermarker_mvp.Models
{
    internal class PayModeModel
    {
        ...
        [StringLength(50, MinimumLength =3, ErrorMessage ="Pay mode name is must be between 3 and 50 characteres")]
        public string Name { get; set; }

        [DisplayName("Observation")]
        [Required(ErrorMessage = "Pay mode observation is required")]
        [StringLength(200, MinimumLength = 3, ErrorMessage = "Pay mode observation is must be between 3 and 200 characteres")]
